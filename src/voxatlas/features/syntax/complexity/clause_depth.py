...
class SyntaxComplexityClauseDepthExtractor(BaseExtractor):
    ...
    3. Complexity computation
       Clause depth counts the maximum nesting depth of clause-typed dependency relations.
...
registry.register(SyntaxComplexityClauseDepthExtractor)
