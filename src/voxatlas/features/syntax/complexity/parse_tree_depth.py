...
class SyntaxComplexityParseTreeDepthExtractor(BaseExtractor):
    ...
    >>> out = SyntaxComplexityParseTreeDepthExtractor().compute(FeatureInput(audio=None, units=None, context={"feature_store": store}), {})
    ...
    def compute(self, feature_input, params):
        ...
        >>> store = FeatureStore()
        >>> store.add("syntax.dependencies", TableFeatureOutput(feature="syntax.dependencies", unit="token", values=deps))
        >>> result = SyntaxComplexityParseTreeDepthExtractor().compute(FeatureInput(audio=None, units=None, context={"feature_store": store}), {})
        >>> result.unit
        'sentence'
        """
