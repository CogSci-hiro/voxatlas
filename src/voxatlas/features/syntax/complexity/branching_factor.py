...
class SyntaxComplexityBranchingFactorExtractor(BaseExtractor):
    r"""
    ...
    3. Complexity computation
       Branching factor is computed as the mean number of children per non-leaf dependency node.
    ...
    --------
        ...
        extractor = SyntaxComplexityBranchingFactorExtractor()
        feature_input = FeatureInput(audio=audio, units=units, context={})
        output = extractor.compute(feature_input, {})
        print(output)
    """
    name = "syntax.complexity.branching_factor"
    ...
    def compute(self, feature_input, params):
        ...
        values = compute_branching_factor_by_sentence(table)
...
registry.register(SyntaxComplexityBranchingFactorExtractor)
