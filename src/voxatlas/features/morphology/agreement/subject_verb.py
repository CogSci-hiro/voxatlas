...
class SubjectVerbAgreementExtractor(BaseExtractor):
    ...
    def compute(self, feature_input, params):
        ...
        values = pd.Series(
            table["SubjectVerbAgreement"].astype("float32").values,
            index=table["id"],
        )
...
registry.register(SubjectVerbAgreementExtractor)
