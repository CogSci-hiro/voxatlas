...
from voxatlas.phonology.rhythm_utils import compute_delta_c
from voxatlas.registry.feature_registry import registry


class RhythmDeltaCExtractor(BaseExtractor):
    r"""
    ...
    2. Metric computation
       Consonant-duration variability is :math:`\Delta C = \mathrm{sd}(d^{(c)})`.
...
registry.register(RhythmDeltaCExtractor)
