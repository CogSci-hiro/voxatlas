...
class RhythmPercentVExtractor(BaseExtractor):
    ...
    ... )
    >>> out = RhythmPercentVExtractor().compute(FeatureInput(audio=None, units=None, context={"feature_store": store}), {})
    ...
    def compute(self, feature_input, params):
        ...
        >>> result = RhythmPercentVExtractor().compute(feature_input, {})
        >>> result.unit
        'ipu'
        """
